  ...
  return (
    <ProseShell active="/docs">
      <div className="mx-auto w-full max-w-[880px] px-5 py-16 sm:px-8 md:py-24">
        ...
        <ul className="mt-12 grid gap-3 sm:grid-cols-2">
          {pages.map((page, i) => (
            <li key={page.slug}>
              <Link
                href={`/docs/${page.slug}`}
                className="group flex h-full flex-col rounded-[24px] border border-line bg-surface p-6 transition-colors hover:border-green"
              >
                ...
                <span className="mt-4 text-[13px] font-medium text-ink-faint group-hover:text-ink">
        ...
        <div className="mt-10 rounded-[24px] bg-field p-6">
